#!/bin/bash
# run_client.sh - Start the Chat Application Client GUI
...
echo "Starting Chat Application Client..."
...
if [ $? -ne 0 ]; then
    echo "Error: Failed to start Chat Application Client. Check Java output above for details."
    exit 1
fi
